...
namespace HautsPermits_Ideology
{
    ...
    public class QuestNode_ArchiveIntermediary : QuestNode_Sequence
    {
        ...
        {
            return HVMP_Utility.TryFindArchiveFaction(out Faction archiveFaction);
        }
    }
    ...
    public class QuestPart_DronePlusGuards : QuestPart
    {
        ...
        public override void Notify_QuestSignalReceived(Signal signal)
        {
            ...
            if (signal.tag == this.inSignal && this.mapParent != null && this.mapParent.HasMap)
            {
                ...
                LordMaker.MakeNewLord(Faction.OfMechanoids, new LordJob_SleepThenMechanoidsDefendDrone(new List<Thing> { this.drone }, Faction.OfMechanoids, 28f, this.spawnedClusterPos, false, false, this.sleepyTime*2500), this.mapParent.Map, spawnedPawns);
    ...
    public class SitePartWorker_CrashedShuttle : SitePartWorker
    {
        public override void Notify_GeneratedByQuestGen(SitePart part, Slate slate, List<Rule> outExtraDescriptionRules, Dictionary<string, string> outExtraDescriptionConstants)
        {
            ...
            Thing shuttle = ThingMaker.MakeThing(ThingDefOf.ShuttleCrashed, null);
