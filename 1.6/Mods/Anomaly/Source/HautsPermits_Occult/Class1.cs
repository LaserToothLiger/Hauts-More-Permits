...
namespace HautsPermits_Occult
{
    ...
    public class QuestNode_Wells : QuestNode
    {
        ...
        protected override void RunInt()
        {
            ...
            bool tandemonium = HVMP_Utility.MutatorEnabled(HVMP_Mod.settings.wells3, mayhemMode);
            int usherCount = 1;
            if (tandemonium)
            {
            ...
            if (HVMP_Utility.MutatorEnabled(HVMP_Mod.settings.wells1, mayhemMode))
            {
            ...
            if (HVMP_Utility.MutatorEnabled(HVMP_Mod.settings.wells2,mayhemMode))
            {
            ...
            if (tandemonium)
            {
                qpwm.TANDY_allSameTarget = this.TANDY_allPawnsSpawnOnSameTarget;
        ...
        public bool TANDY_allPawnsSpawnOnSameTarget;
        [MustTranslate]
    ...
    public class QuestPart_WellsMutators : QuestPart
    {
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look<bool>(ref this.TANDY_allSameTarget, "TANDY_allSameTarget", true, false);
        }
        public PawnKindDef usherKind;
        public HediffDef FS_hediff;
        public HediffDef NSD_hediff;
        ...
        public bool TANDY_allSameTarget;
    }
