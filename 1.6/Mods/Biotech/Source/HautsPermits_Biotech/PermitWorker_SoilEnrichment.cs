...
{
    /*improve the fertility of all terrain in radius of the target point. Also unpollute that terrain, potentially spawning a wastepack
     * only affects non-floor, non-water, non-floor, sand, soil, and other fertile terrain*/
